...
//import { useForm, SubmitHandler  } from 'react-hook-form'  //use this because we use typescript
      ...
      <div className="bg-white w-full max-w-lg p-4 mt-8 mx-auto rounded">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-4 grid gap-4">
            <div className="grid gap-1">
                ...
                <input type="text" id="addressline" className="border bg-blue-50 p-2 rounded" {...register("addressline",{required : true })} />
            </div>
            <div className="grid gap-1">
